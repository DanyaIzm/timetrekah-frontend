  ...
  var t = {
      838: function (t) {
        t.exports = (function () {
          ...
          function M(t) {
            for (let e = 0; e < t.length; e++) y(t, e) || (t[e] = null);
            return t;
          }
          function E(e) {
            const i = r(null);
          ...
          return (function e() {
            ...
            const o = s,
              l = o.currentScript,
              {
                ...
                Element: M,
                NodeFilter: H,
                NamedNodeMap: F = i.NamedNodeMap || i.MozNamedAttrMap,
                HTMLFormElement: q,
                DOMParser: $,
                trustedTypes: U,
              } = i,
            ...
            const he = s.createElement("form"),
              ...
              ce = function () {
                ...
                if (!le || le !== t) {
                  if (
                    ...
                    (t = E(t)),
                    (ne =
                      -1 === oe.indexOf(t.PARSER_MEDIA_TYPE)
                        ? "text/html"
                        : t.PARSER_MEDIA_TYPE),
                    ...
                    (Tt = y(t, "ALLOWED_ATTR")
                      ? T({}, t.ALLOWED_ATTR, re)
                      : Mt),
                    (ae = y(t, "ALLOWED_NAMESPACES")
                      ? T({}, t.ALLOWED_NAMESPACES, _)
                      : se),
                    (Xt = y(t, "ADD_URI_SAFE_ATTR")
                      ? T(E(Jt), t.ADD_URI_SAFE_ATTR, re)
                      : Jt),
                    (Zt = y(t, "ADD_DATA_URI_TAGS")
                      ? T(E(Vt), t.ADD_DATA_URI_TAGS, re)
                      : Vt),
                    (Gt = y(t, "FORBID_CONTENTS")
                      ? T({}, t.FORBID_CONTENTS, re)
                      : Yt),
                    ...
                    t.CUSTOM_ELEMENT_HANDLING &&
                      de(t.CUSTOM_ELEMENT_HANDLING.tagNameCheck) &&
                      (Et.tagNameCheck =
                        t.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
                    t.CUSTOM_ELEMENT_HANDLING &&
                      de(t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) &&
                    ...
                    Wt &&
                      ((kt = T({}, O)),
                      (Tt = []),
                      !0 === Wt.html && (T(kt, D), T(Tt, R)),
                      !0 === Wt.svg && (T(kt, S), T(Tt, j), T(Tt, z)),
                      !0 === Wt.svgFilters && (T(kt, N), T(Tt, j), T(Tt, z)),
                      !0 === Wt.mathMl && (T(kt, C), T(Tt, P), T(Tt, z))),
                    t.ADD_TAGS &&
                      (kt === xt && (kt = E(kt)), T(kt, t.ADD_TAGS, re)),
                    t.ADD_ATTR &&
                      (Tt === Mt && (Tt = E(Tt)), T(Tt, t.ADD_ATTR, re)),
                    t.ADD_URI_SAFE_ATTR && T(Xt, t.ADD_URI_SAFE_ATTR, re),
                    t.FORBID_CONTENTS &&
                      (Gt === Yt && (Gt = E(Gt)), T(Gt, t.FORBID_CONTENTS, re)),
                    Ut && (kt["#text"] = !0),
                    Rt && T(kt, ["html", "head", "body"]),
                    kt.table && (T(kt, ["tbody"]), delete Lt.tbody),
                    ...
                    if (
                      "function" !=
                      typeof t.TRUSTED_TYPES_POLICY.createScriptURL
                    )
                      throw w(
                        'TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.'
                      );
                    (nt = t.TRUSTED_TYPES_POLICY), (ot = nt.createHTML(""));
                  } else
                    void 0 === nt &&
                      (nt = (function (t, e) {
                        if (
              ...
              ve = function (t, e) {
                try {
                  u(a.removed, { attribute: e.getAttributeNode(t), from: e });
                } catch (t) {
                  u(a.removed, { attribute: null, from: e });
                }
              ...
              Te = function (t) {
                let e = null;
                if ((xe("beforeSanitizeElements", t, null), we(t)))
                  return ge(t), !0;
                const i = re(t.nodeName);
                if (
                  (xe("uponSanitizeElement", t, {
                    tagName: i,
                    allowedTags: kt,
                  }),
                  t.hasChildNodes() &&
                    !ke(t.firstElementChild) &&
                    b(/<[/\w]/g, t.innerHTML) &&
                    b(/<[/\w]/g, t.textContent))
                )
                  return ge(t), !0;
                if (t.nodeType === K) return ge(t), !0;
                ...
                return t instanceof M &&
                  !(function (t) {
                    let e = st(t);
                    (e && e.tagName) ||
                      (e = { namespaceURI: ee, tagName: "template" });
                    const i = m(t.tagName),
                      a = m(e.tagName);
                    return (
                      !!ae[t.namespaceURI] &&
                        ...
                        : t.namespaceURI === Kt
                          ? e.namespaceURI === te
                            ...
                            : e.namespaceURI === Qt
                              ...
                              : Boolean(fe[i])
                          : t.namespaceURI === te
                            ? !(e.namespaceURI === Qt && !me[a]) &&
                              !(e.namespaceURI === Kt && !ue[a]) &&
                              !fe[i] &&
                              (_e[i] || !pe[i])
                            : !(
                                "application/xhtml+xml" !== ne ||
                  ...
                  : ("noscript" !== i && "noembed" !== i && "noframes" !== i) ||
                    ...
                    ? (It &&
                        ...
                        t.textContent !== e &&
                          (u(a.removed, { element: t.cloneNode() }),
                          (t.textContent = e))),
                    ...
                    !(
                      (Ee(t) &&
                        ...
                        ((Et.attributeNameCheck instanceof RegExp &&
                          b(Et.attributeNameCheck, e)) ||
                          (Et.attributeNameCheck instanceof Function &&
                            Et.attributeNameCheck(e)))) ||
                      ("is" === e &&
                        Et.allowCustomizedBuiltInElements &&
                        ((Et.tagNameCheck instanceof RegExp &&
                          b(Et.tagNameCheck, i)) ||
              ...
              De = function t(e) {
                ...
                const a = be(e);
                for (
                  xe("beforeSanitizeShadowDOM", e, null);
                  (i = a.nextNode());

                )
                  xe("uponSanitizeShadowNode", i, null),
                    Te(i) || (i.content instanceof h && t(i.content), Le(i));
            ...
            return (
              (a.sanitize = function (t) {
                ...
                if (
                  ...
                  if (((i = ye(t)), !i)) return zt ? null : Ft ? ot : "";
                }
                i && Pt && ge(i.firstChild);
                const l = be(Bt ? t : i);
                for (; (n = l.nextNode()); )
                  Te(n) || (n.content instanceof h && De(n.content), Le(n));
                if (Bt) return t;
                if (zt) {
                  if (Ht)
                  ...
                  return (
                    (Tt.shadowroot || Tt.shadowrootmode) &&
                      (r = ct.call(o, r, !0)),
                    r
                  );
                }
                ...
                return (
                  Rt &&
                    ...
                    b(Y, i.ownerDocument.doctype.name) &&
                    (c =
              ...
              (a.addHook = function (t, e) {
                "function" == typeof e && ((ut[t] = ut[t] || []), u(ut[t], e));
              }),
              (a.removeHook = function (t) {
                if (ut[t]) return c(ut[t]);
              }),
  ...
  (() => {
    ...
    function j(t) {
      ...
      for (var e = 0; e < 31; e++)
        t = t.replace(
          new RegExp(
            "ГЈГ ГЎГ¤ГўбєЅГЁГ©Г«ГЄГ¬ГГЇГ®ГµГІГіГ¶ГґГ№ГєГјГ»Г±Г§В·/_,:;".charAt(
              e
            ),
            "g"
          ),
    ...
    function $(t, e, i) {
      var a = function (t, e, i) {
        return (
          i || (i = ""),
          e && e.length > 30 && (e = e.substring(0, 30) + "вЂ¦"),
          i +
      ...
      W = (t) =>
        null !== t.w && "" !== t.w
          ...
          : null !== t.h && "" !== t.h
            ...
            : 0;
    let G =
      ((Z = (Y = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ")
        .length),
      {
        encode: function (t) {
    ...
    const nt = (function () {
      ...
      function k(t, e) {
        ...
        return (
          ...
          (i = t.match(m)) &&
            ((a.skewx = A(i[1], e ? e.skewx : null)),
            (a.skewy = A(i[3], e ? e.skewy : null))),
          (i = t.match(_)) &&
            ((a.translatex = A(i[1], e ? e.translatex : null)),
        ...
        for (
          ...
          if (((u[i] = {}), (m[i] = {}), (_[i] = {}), c)) {
            var y = v(n[i], "left"),
              b = v(n[i], "top"),
              w = [
                A(E(a) ? a(n[i]) : a || 0, parseFloat(y)),
                A(E(s) ? s(n[i]) : s || 0, parseFloat(b)),
              ];
            (p[i] = E(c) ? c(n[i], w) : c),
              p[i].push(w),
          ...
          for (var L in e) {
            ...
            var C,
              I = v(n[i], L),
              O = E(e[L]) ? e[L](n[i]) : e[L];
            "string" != typeof O || !l.test(O) || l.test(I)
              ? ((u[i][L] =
                  "transform" == L
                    ? k(I)
                    : "string" == typeof O && l.test(O)
                      ? T(I).slice(1)
                      : parseFloat(I)),
                (m[i][L] =
                  "transform" == L
                    ? k(O, u[i][L])
                    : "string" == typeof O && "#" == O.charAt(0)
                      ? T(O).slice(1)
                      : A(O, parseFloat(I))),
                "string" == typeof O && (C = O.match(d)) && (_[i][L] = C[1]))
              : delete e[L];
          }
        }
        return D.apply(n, [
            ...
            (i.fn[t] = function () {
              var t,
                ...
                n = i.map(arguments, function (e) {
                  return "object" == (t = N(e)) || "array" == t || null == e
                    ? e
                    : E.fragment(e);
                }),
                o = this.length > 1;
      ...
      formatBigYear(t, e) {
        ...
        if (a) {
          for (var s = 0; s < a.length; s++) {
            var n = a[s];
            if (Math.abs(i / n[0]) > 1) return Ct(Math.abs(i / n[0]), n[1]);
          }
          return i.toString();
        }
        return (
      ...
      formatJSDate(t, e) {
        ...
        var n = "get",
          ...
          p = {
            ...
            o:
              (_ > 0 ? "-" : "+") +
              N(100 * Math.floor(Math.abs(_) / 60) + (Math.abs(_) % 60), 4),
            S: ["th", "st", "nd", "rd"][
    ...
    (Nt.fallback = { messages: {} }),
      (Nt.DATE_FORMAT_TOKENS =
      ...
      en: {
        ...
        messages: {
          ...
          invalid_integer_option:
            "Invalid option valueвЂ”must be a whole number.",
    ...
    const qt = { human: yt, cosmological: Dt };
    var $t = i(838),
      Ut = i.n($t);
    const Bt = { text: ["headline", "text"], media: ["caption", "credit"] },
      Wt = {
    ...
    ae("human", _t), ae("cosmological", Lt);
    const se = {
    ...
    class re {
      ...
      _initLayout() {
        (this._el.container = v("div", "tl-timeera")),
          ...
          this.headline &&
            "" != this.headline &&
            (this._text.innerHTML = F(this.headline)),
          this.onLoaded();
      }
      _initEvents() {}
      _updateDisplay(t, e, i) {
    ...
    class pe extends de {
      _loadMedia() {
        ...
        (this.youtube_loaded = !1),
          ...
          ue("https://www.youtube.com/iframe_api", function () {
            e.createMedia();
          });
      }
      _updateMediaDisplay() {
    ...
    class ge extends de {
      constructor(t, e, i) {
        super(t, e, i), (this.blockquote = Ut().sanitize(this.data.url));
      }
      _loadMedia() {
        (this._el.content_item = this.domCreate(
          "div",
    ...
    class ye extends de {
      ...
      _getImageURL(t, e) {
        if (t && this.base_image_url) {
          ...
          if (e)
            return (
              (t = Math.round(t)), this.base_image_url.replace(e[1], `/${t}px-`)
            );
        }
    ...
    class Te extends de {
      ...
      createMedia(t) {
        ...
        (n = t.html.split("</p>&mdash;")[0] + "</p></blockquote>"),
          ...
          )).includes("pic.twitter.com") || n.includes("pic.x.com")
            ? (ue("https://platform.twitter.com/widgets.js", function () {
      ...
      _loadMedia() {
        ...
        (this._el.content_item = this.domCreate(
          ...
          (this.media_id = (e = this.data.url).match(/^spotify:/)
            ? e
            : `spotify${(e = new URL(e)).pathname.replace(/\/$/, "").replace(/\//g, ":")}`),
          this.media_id
            ? ((t =
    ...
    class Re extends de {
      constructor(t, e, i) {
        super(t, e, i),
          (this.iframe = Ut().sanitize(this.data.url, {
            ADD_TAGS: ["iframe"],
    ...
    function qe(t, e) {
      var i = [
        ...
        { type: "iframe", name: "iFrame", match_str: "iframe", cls: Re },
        { type: "blockquote", name: "Quote", match_str: "blockquote", cls: ge },
        {
          type: "video",
          name: "Video",
        ...
        { type: "imageblank", name: "Imageblank", match_str: "", cls: ce },
      ];
      if (e) {
    ...
    class Be {
      ...
      _initLayout() {
        (this._el.line = v("div", "tl-timenav-line", this._el.container)),
          ...
          (this.timeaxis = new le(
            this._el.timeaxis,
            this.options,
            this.language
          )),
          (this._swipable = new Ue(
    ...
    class We {
      ...
      _initLayout() {
        ...
        this.data.media &&
          ...
          (this.has.text || this.has.headline) &&
            ((this._text = new he(this.data.text, {
    ...
    class Ye {
      constructor(t, e, i, a) {
        a && this.setLanguage(a),
          ...
          "object" == typeof t
            ? ((this._el.container = t), (this.options.id = P(6, "tl")))
    ...
    class Xe {
      ...
      _initGoogleAnalytics(t) {
        ue(`https://www.googletagmanager.com/gtag/js?id=${t}`),
    ...
    async function Je(t, e) {
      return (
        e || (e = "https://sheets-proxy.knightlab.com/proxy/"),
        await te(t, { sheets_proxy: e })
      );
    }
    R(Xe, Rt, at);
  })(),
